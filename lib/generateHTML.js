    ...
    switch(team[i].getRole()){
      ...
      case 'Engineer':
        ...
        <div class="card border-info">
          <h3 class="card-header bg-info">${team[i].name}</h3>
          <div class="card-body">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">ID: ${team[i].id}</li>
              <li class="list-group-item">Role: ${team[i].getRole()}</li>
              <li class="list-group-item">Email: ${team[i].email}</li>
              <li class="list-group-item">Link to Github &#128435: <a href = "https://github.com/${team[i].github}"> ${team[i].github}</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      case 'Intern':
        ...
        <div class="card border-success">
          <h3 class="card-header bg-success">${team[i].name}</h3>
          <div class="card-body">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">ID: ${team[i].id}</li>
              <li class="list-group-item">Role: ${team[i].getRole()}</li>
