...
<body>
  ...
  for(let i=0; i<team.length; i++){
    switch(team[i].getRole()){
      case 'Manager':
        textNode = `
          <div class="card border-danger col-12 col-md-4 cardStyle" style="width: 18rem;">
    <h3 class="card-header bg-danger mb-3">${team[i].name}</h3>
    <div class="card-body">
      ...
      case 'Engineer':
        textNode = `
          <div class="card border-info col-12 col-md-4 cardStyle" style="width: 18rem;">
    <h3 class="card-header bg-info mb-3">${team[i].name}</h3>
    <div class="card-body">
        <ul class="list-group list-group-flush">
          <li class="list-group-item">Role: ${team[i].getRole()}</li>
          <li class="list-group-item">ID: ${team[i].id}</li>
      ...
      case 'Intern':
        textNode = `
          <div class="card border-success col-12 col-md-4 cardStyle" style="width: 18rem;">
    <h3 class="card-header bg-success mb-3">${team[i].name}</h3>
    <div class="card-body">
        <ul class="list-group list-group-flush">
          <li class="list-group-item">Role: ${team[i].getRole()}</li>
          <li class="list-group-item">ID: ${team[i].id}</li>
