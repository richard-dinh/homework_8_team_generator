...
<body>
  ...
  for(let i=0; i<team.length; i++){
    switch(team[i].getRole()){
      case 'Manager':
        textNode = `
          <div class="card border-danger col-12 col-md-4" style="width: 18rem;">
    ...
    <div class="card-body">
      ...
      case 'Engineer':
        textNode = `
          <div class="card border-info col-12 col-md-4" style="width: 18rem;">
    ...
    <div class="card-body">
      ...
      case 'Intern':
        textNode = `
          <div class="card border-success col-12 col-md-4" style="width: 18rem;">
